...
import { AppState, View, Text, Image, SafeAreaView, Animated, Easing } from 'react-native';
...
import UserListContainer from '../Main/UserListContainer';
...
const ContactsSCreen = () => {
  ...
  const spin = () => {
    setSettingsPressed(!isSettingsPressed); // Toggle the isSettingsPressed state
    spinValue.setValue(0);
    Animated.timing(spinValue, {
      toValue: isSettingsPressed ? 1 : -1, // Toggle the direction
      duration: 700,
  ...
  return (
    <SafeAreaView style={{ flex: 1, width: '100%', backgroundColor: 'white' }}>
      ...
      <ButtonContainer handleLogout={handleLogout} spinValue={spinValue} isSettingsPressed={isSettingsPressed} spin={spin} />
